...
Revision ID: ed421d04f4c4
Revises:
Create Date: 2026-06-15 11:07:24.978701
...
def upgrade() -> None:
    ...
    op.create_table(
        "players",
        sa.Column("discord_id", sa.Integer(), autoincrement=False, nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("player_discord_id", sa.Integer(), nullable=False),
        ...
        sa.UniqueConstraint(
            "fixture_id", "player_discord_id", "category", name="uq_bet_per_category"
        ),
    )
